...
import { fetchPropertyDetails } from "@/utils/request";
...
const PropertyEditForm = () => {
  ...
  useEffect(() => {
    ...
    const fetchPropertyData = async () => {
      try {
        ...
        //Check rates for null; set null values to empty strings
  ...
  const handleAmenitiesChange = (e) => {
    ...
    setFields(prevState => {
      if (prevState.amenities.includes(value)) {
        return {
          ...prevState,
    ...
    <form onSubmit={submitHandler}>
      ...
      <div className="mb-4 bg-blue-50 p-4">
        ...
        <input
          ...
          required
          value={fields.location.province}
          onChange={handleChange}
        />
        <input
          type="text"
          ...
          value={fields.location.postalCode}
          onChange={handleChange}
        />
      </div>
